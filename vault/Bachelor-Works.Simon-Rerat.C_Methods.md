...
_<center>Graphe C-02: Visual representation of the bundling of samples with UUIds. The original individual, source of the sample is known.</center>_
...
### Sampling
  ...
  At least 5 pictures must be taken for each sample:
    ...
    3) The identification panel with the UUID QR-code and the number of the sample.
 ...
 _<center>Fig.C-07: Detailled picture of a branch, needles, and buds of Picea jezoensis</center>_
  ...
  Afterward, as much of the supernatant (usually 1,4ml) is collected and pipetted in a glass vial with a hermetically sealed cap. Floating particles need to be avoided for they clogg the LC-MS.
...
flowchart TB
    ...
    K[10. Put 1,4ml of supernatant in 2ml storage vials]-->

  L([11.Take 120μl of the sample for analysis])-->
  M([12. Put the 120μl sample in the LC-MS])-->
  N([13. Furter analysis with ProteoWizard, GNPS, MZmine, and Cytsocape])-->
